...
const catalogProducts = [
  ...
  { name: '', category: 'Banco que Vira Mesa', image: img5 },
  { name: '', category: 'Banco que Vira Mesa', image: img6 },
  { name: '', category: 'Banco que Vira Mesa', image: img7 },
  { name: '', category: 'Banco que Vira Mesa', image: img8 },
