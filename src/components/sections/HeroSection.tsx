    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-premium relative z-10 pt-24 pb-16">
        <div className="max-w-3xl">
          ...
          >
            <a
              href="https://wa.me/555192438775" 
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-10 py-4 bg-[#25D366] text-white font-medium text-sm tracking-wide hover:bg-[#128C7E] transition-all duration-300 group shadow-lg"
            >
              Compre pelo Whats
